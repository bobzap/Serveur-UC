...
_OPFmen = ["SWOP_CIS_droid","SWOP_CIS_droid_AT","SWOP_CIS_droid_mg","SWOP_CIS_droid_crew","SWOP_CIS_droid_crew","SWOP_CIS_droid_crew","SWOP_CIS_droid","SWOP_CIS_droid_mg","SWOP_CIS_droid_mg","RD501_droid_AA","B2_superdroid_Rocket","SWOP_CIS_droid_EWEB","SWOP_CIS_droid","SWOP_CIS_droid","SWOP_CIS_droid","SWOP_CIS_droid_guard"];
_OPFmen2 = ["SWOP_CIS_droid_AT"];
_OPFarrays = [_OPFmen,_OPFmen2];
_INDmen = ["SWOP_Mando_True_sold","SWOP_Mando_True_serg","SWOP_Mando_True_jumper","SWOP_Mando_True_mg","SWOP_Mando_True_sold","SWOP_Mando_True_of","SWOP_Mando_True_AT","SWOP_Mando_True_sniper","SWOP_Band_week_smug"];
