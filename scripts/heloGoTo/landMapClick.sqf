...
_heli removeAction NORRN_heliGoToRTB_action;
NORRN_heliGoToCancel_action = _heli addAction  ["Annuler l'ordre", "scripts\heloGoTo\cancelGotoAction.sqf", _heli,0, false];
NORRN_heloGotoMapClick = true;
titletext ["Ouvrir votre DataMap et placer la DZ","plain down"];
