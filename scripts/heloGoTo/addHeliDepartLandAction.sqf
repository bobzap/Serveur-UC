...
NORRN_getTheFoutOfDodge_action = player addAction ["Informer que tout le monde est descendu !", "scripts\heloGoTo\heliDepartLandAction.sqf",[_unit, _heli],1, false];
_pilot = driver _heli;
hint "Informer que tout le monde est descendu !";
