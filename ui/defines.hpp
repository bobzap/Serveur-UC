...
#define COLOR_BROWN { 0.1, 0.1, 0.1, 0.9 }
#define COLOR_GREEN { 0.08, 0.3, 0.68, 0.7 }
#define COLOR_GREEN_ALPHA { 0.08, 0.3, 0.68, 0.4 }
#define COLOR_GREEN_NOALPHA { 0.08, 0.3, 0.68, 0.8 }
